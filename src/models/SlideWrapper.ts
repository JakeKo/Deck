...
export default class SlideWrapper implements ISlideWrapper {
    ...
    private _forwardGraphicEvents(graphicId: string, svg: SVG.Element): void {
        ...
        svg.on('mousemove', (baseEvent: MouseEvent): void => {
